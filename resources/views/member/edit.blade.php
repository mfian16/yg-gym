            ...
            <div class="col-12">
                <div class="row mb-4 align-items-start">
                    ...
                    <div class="col-md-6 text-center">
                        <div class="mx-auto mb-2" style="width:180px;">
                            @if($member->foto)
                        ...
                        <label class="form-label d-block">Ganti Foto</label>
                    ...
                    <div class="col-md-6 text-center">
                        @if($member->qr_code)
                            ...
                            <div class="mx-auto mb-2" style="width:150px;">
                                {!! QrCode::size(150)->generate($member->qr_code) !!}
                            </div>

                            <label class="form-label d-block">QR Code Member</label>
